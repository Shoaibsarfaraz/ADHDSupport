...
export const Courses = () => {
  const { user, courses, setCourses, setUser } = useUser();
            ...
            <div className="bg-white rounded-lg shadow-md p-6 h-fit sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  disabled={user?.enrolledCourses.includes(selectedCourse._id!)}
                  className={`w-full py-2 rounded-lg font-medium transition ${
                ...
                >
                  {user?.enrolledCourses.includes(selectedCourse._id!) ? 'Enrolled' : 'Enroll Now'}
                </button>
              </div>
            </div>
          )}
